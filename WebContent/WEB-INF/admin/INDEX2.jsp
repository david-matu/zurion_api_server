...
<div class="container h-100">
	<h1 class="font-weight-boldest text-center mb-5 pt-5 pb-5 bubbles"> <hr class="bg-white">
		<a class="" href="${pageContext.request.contextPath }/home"><x-sign><small><em>Congratulation!</em></small><br>App Ready</x-sign></a>
	</h1>
			...
			<div class="card-body">
				...
				<form class=" p-0 p-md-2" id="login-form" method="POST" action="${pageContext.request.contextPath}/signin">
					...
					<div class="form-group">
						<input type="submit" value="Login" class="btn btn-lg float-right btn-success">
					</div>

...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
			...
			<form class="form card shadow shadow-lg p-4" id="advancedcontact-form" method="POST" action="${pageContext.request.contextPath}/sudo/create/advancedcontact">
				...
				<div class='form-group mb-3'>
					...
					<input type="number" name="idNumber" id="idNumber" class="form-control" value="" min="0" required/>
				</div>
				...
				<div class='form-group mb-3'>
					...
					<select class="form-control form-control-select" name="gender" id="gender" class="form-control">
						<option>MALE</option>
				...
				<div class='form-group mb-3 d-none'>
					...
					<input type="date" name="dateCreated" id="dateCreated" class="form-control" value=""/>
				</div>
				...
				<input type="hidden" id="nextURL" name="nextURL" value="${pageContext.request.contextPath}/sudo/listing/advancedcontact"/>
